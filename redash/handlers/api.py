...
from redash.handlers.custom_sql_api import (
    PublicSQLExecutionResource,
    )
...
# Register the new custom API endpoints
api.add_org_resource(PublicSQLExecutionResource, "/api/sqls/execution", endpoint="sql_execution")
